...
1. Провели `предобработку` типов данных, пропусков, дубликатов и некорректных значений.

2. Провели детальный анализ отсутствия **ESRB рейтинга**  в зависимости от `стран` выпуска и продажи.
